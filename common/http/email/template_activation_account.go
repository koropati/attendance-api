...
func GenerateTemplateActivationAccount(linkActivation string, userName string, userEmail string) (html string) {
                                          ...
                                          <tbody>
                                             <tr>
                                                <td width="100%%" align="center">
                                                   ...
                                                   Hello %s<%s>, <br>Thank you for Registration!
                                                   </h1>
                                                </td>
                                             </tr>
                                          </tbody>
                                          ...
                                          <tbody>
                                             <tr>
                                                <td width="100%%" align="center">
                                                   ...
                                                   You are just one step away from completing your registration, activate your account by clicking the button below to start your jurney in blogging and gain access to Wokdev Blog, All tutorials and freebies!
                                                   </p>
                                                </td>
                                             </tr>
                                          </tbody>
...
<!-- END BODY -->`,
		...
		linkActivation,
		linkActivation,
		CONFIG_SOCIAL_FACEBOOK_URL,
		CONFIG_SOCIAL_TWITTER_URL,
		CONFIG_SOCIAL_LINKEDIN_URL,
		CONFIG_SOCIAL_INSTAGRAM_URL,
		CONFIG_SOCIAL_YOUTUBE_URL,
		CONFIG_SOCIAL_EMAIL_URL,
		CONFIG_SOCIAL_GITHUB_URL,
		CONFIG_WEB_NAME,
		CONFIG_TERM_OF_USE_URL,
